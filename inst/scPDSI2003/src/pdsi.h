...
public:
    ...
    // Rcpp::NumericVector PE_vec;

    // Rcpp::NumericMatrix vals_mat;
    // Rcpp::NumericMatrix coefs_mat;

    // //NumericVector d_vec;
    // //NumericVector Z_vec;
    
    // void Rext_init(Rcpp::NumericVector& P, Rcpp::NumericVector& PE,
    //                number AWC,
    //                int s_yr, int e_yr,
    ...
    // void Rext_get_Rvec(Rcpp::NumericVector R_vec, int year, number* A, int freq);

    // void Rext_output_X();
    // Rcpp::NumericVector Rext_out_params();
